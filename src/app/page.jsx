...
export default function Home() {
  return (
    <>
      ...
      <svg
        className="relative z-10 w-full h-12 text-brand-secondary -mb-16"
        viewBox="0 0 1024 64"
      ...
      <section
        className="bg-accent-dark w-full sticky bottom-0 z-0 flex flex-col items-center text-white"
        id="contact-section"
      >
        ...
        <div className="flex flex-col space-y-4 items-start mt-6">
          <a
            ...
            target="#blank"
            className="flex font-sans items-center space-x-3 font-medium justify-center w-fit hover:underline text-base md:text-2xl"
          >
            <svg
              width="36"
              height="36"
        ...
        <p className="text-base font-bold py-12">
