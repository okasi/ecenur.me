    ...
    <BrickSection id="projects-section">
      ...
      <div className="mx-auto my-8 max-w-5xl">
        ...
        <div className="flex flex-col-reverse items-center justify-between md:flex-row md:items-stretch md:space-x-4">
          <div className="mt-4 flex aspect-[4/3] max-w-[68.75%] flex-col justify-center rounded-2xl border-4 border-accent-green bg-white p-4 md:mt-0 md:max-w-[50%]">
            <Image
          ...
          <div className="rounded-2xl bg-accent-green p-6 md:max-w-[50%]">
            ...
            <p className="mt-4 text-lg">
              Creating a new brand and service where people can book time slots
              at their nearest workshop to change their tires. Designing
        ...
        <div className="flex flex-col items-center justify-between md:flex-row md:items-stretch md:space-x-4">
          <div className="rounded-2xl bg-accent-beige p-6 md:max-w-[50%]">
          ...
          <div className="relative mt-4 flex max-w-[68.75%] flex-col justify-center rounded-2xl border-4 border-accent-beige bg-white p-4 md:mt-0 md:aspect-[4/3] md:max-w-[50%]">
            <Image
              src="/preschool.jpg"
              alt="preschool"
              height={320}
